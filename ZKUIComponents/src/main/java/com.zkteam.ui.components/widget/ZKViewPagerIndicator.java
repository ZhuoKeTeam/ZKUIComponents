...
public class ZKViewPagerIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public ZKViewPagerIndicator(Context context) {
        super(context);
        init();
    }

    public ZKViewPagerIndicator(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        getAttr(context, attrs);
        init();
    }

    public ZKViewPagerIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public ZKViewPagerIndicator(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void getAttr(Context context, AttributeSet attrs) {
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ZKViewPagerIndicator);
        mRadius = (int) typedArray.getDimensionPixelSize(R.styleable.ZKViewPagerIndicator_indicatorRadius, dpToPx(6));
        mStrokeWidth = (int) typedArray.getDimensionPixelSize(R.styleable.ZKViewPagerIndicator_indicatorBorderWidth, dpToPx(2));
        ...
        int fillMode = typedArray.getInt(R.styleable.ZKViewPagerIndicator_fill_mode, 2);
        if (fillMode == 0) {
